...
require_once dirname(__DIR__) . '/includes/notifications.php'; // Thêm để sử dụng createJoinGroupNotification
...
<div class="container mt-5">
    ...
    <?php else: ?>
        ...
        <?php else: ?>
                ...
                <?php foreach ($groups as $group): ?>
                    <div class="course-suggest-card">
                        ...
                        <div class="course-details">
                            ...
                            <a href="<?php echo BASE_URL; ?>teacher/index.php?tab=groups&group_id=<?php echo $group['id']; ?>" class="btn btn-info btn-sm mt-2">Xem thành viên</a>
            ...
            <?php if ($groupId): ?>
                <h3>Thành viên nhóm - <?php echo htmlspecialchars($groups[array_search($groupId, array_column($groups, 'id'))]['name']); ?></h3>
                <!-- Form thêm thành viên -->
                <form method="POST" class="mb-4">
                    <input type="hidden" name="action" value="add_member">
                    <input type="hidden" name="group_id" value="<?php echo $groupId; ?>">
                    <div class="form-group">
                        <label for="user_id">Thêm sinh viên:</label>
                    ...
                    <ul class="list-group">
                        <?php foreach ($members as $member): ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <form method="POST" style="display:inline;" onsubmit="return confirm('Bạn có chắc muốn kick thành viên này?');">
